  ...
  const config: any = {
    loader: {
      load: [
        ...
        '[tex]/braket',
        '[tex]/mathtools',
        // Chemical equations: `\ce{Ca(OH)2 -> CaO + H2O}`. Loaded here so they
        // are typeset at build time like every other formula, rather than by a
        // MathJax bundle fetched in the reader's browser.
        '[tex]/mhchem',
      ],
    ...
    tex: {
      tags: 'ams',
      packages: {
        '[+]': ['boldsymbol', 'braket', 'mathtools', 'mhchem'],
      },
    },
    output: {
      font,
